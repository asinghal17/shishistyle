"""
Django settings for shishistyle project.
...
SECRET_KEY = quote_plus(os.environ['secret_key']) 
...
# WSGI_APPLICATION = "shishistyle.wsgi.application"
WSGI_APPLICATION = 'shishistyle.wsgi.app'
